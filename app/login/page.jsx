...
export default function Login() {
  ...
  return (
    <div className="flex justify-center items-center h-screen w-screen bg-gray-900 relative px-2">
      <div className="w-full sm:w-[80%] xl:w-[60%] flex items-center justify-center p-2">
        <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden">
          <div className="md:flex w-full">
            ...
            <form
              ...
              className="w-full md:w-1/2 py-10 md:py-20 px-5 md:px-10"
            >
