...
function AddAdmin({setIsAdding,fetchData}) {
  ...
  return (
    <div>
      ...
      <div className="absolute left-0 right-0 bottom-0 top-0 m-auto w-8/12 h-4/6 bg-white max-w-2xl rounded-lg z-10 ">
        <AiOutlineClose
...
<form className="mx-10 mb-6" onSubmit={handleSubmit}>
    <div className="grid gap-6 mb-6 md:grid-cols-2">
        <div>
            <label htmlFor="Institution Name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Admin Name</label>
